...
from config import *
from sprites import Sprite, Plataforma_Movel, Espinho
        ...
        for obj in tmx_map.get_layer_by_name("Dano"):
                ...
                if obj.name == "espinho":
                    ...
                    if direcao_movi == "y":
                            ...
                            self.espinho = Espinho((self.all_sprites, self.dano_sprites),
                                                                 pos_inicial, pos_final, direcao_movi, vel, obj.width,obj.height)
